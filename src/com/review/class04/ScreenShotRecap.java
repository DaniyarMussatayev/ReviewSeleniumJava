...
public class ScreenShotRecap extends CommonMethods {
	...
	/*
	 * 1.Taking screen shots in Selenium 2. Advanced Xpath 3.Actions Class 4.
	 * JavaScriptExecutor 5.How to upload a file with selenium
	 * 
	 */
	...
	public static void main(String[] args) throws InterruptedException {
		 ...
		 * NoSuchElemnetException - Unexpected alerts inside the application - Assertion
		 * issues
		 * 
		 */

		/*
		 * How to take screenshots - TakeScreenshot interface - getScreenShotsAs() -->
		 * 
		...
		// 2. Take Screenshoots for verification
		// 1. Create an object of TakesScreenshot interface indirectly by downcasting it to webdriver
